...
describe SumLord do
  ...
  it 'small/large sets' do
    puts "\nSmall set: #{small_set.size} x #{small_set.size}"
    puts "\nLarge set: #{large_set.size} x #{large_set.size}"
  end
  ...
  context 'Benchmarks' do
    context 'Approach 1: Traditional Iterative Summing' do
    ...
    context 'Approach 2: Celloid-Based Concurent Summing' do
      ...
      context 'Approach 3: Celluloid actors preinitialized' do
        it 'should display benchmarks for small set' do
          summers = initialize_summers small_set
